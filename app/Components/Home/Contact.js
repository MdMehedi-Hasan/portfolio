...
export default function Contact() {
  ...
  return (
    <div className="mb-10 mt-10">
      ...
      <h1
        className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl tracking-wider leading-snug mb-5 mt-10"
        // data-aos="fade-up"
        // data-aos-duration="1500"
      >
      ...
      >
        ...
        <div className="flex justify-end col-span-2">
          <input
            type="submit"
            value="SEND MESSAGE"
            className="bg-primary text-black rounded-full px-10 py-3 cursor-pointer"
          />
        </div>
      </form>
    </div>
