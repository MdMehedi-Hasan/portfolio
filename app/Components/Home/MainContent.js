  ...
  return (
    <div className="text-white relative lg:pl-10">
      ...
      <button
        ...
        className="border border-gray rounded-full p-2 text-xl fixed top-5 right-10 z-10"
      >
        <HiMenuAlt4 />
      </button>
      ...
      <SwipeableDrawer
        ...
        BackdropProps={{
          style: { backgroundColor: "#565656", opacity: "0.5" },
        }}
      >
        <div className="flex items-center justify-center">
          <div className="w-fit mt-16">
            ...
            <ul className="w-36 px-2 py-3 flex flex-col gap-3">
              <li className="text-secondary hover:text-white duration-200">
              ...
              <li className="text-secondary hover:text-white duration-200">
                <a href="#services" className="flex items-center gap-2">
                  <CgMenuRightAlt className="text-primary" />
                  Services
                </a>
              </li>
              <li className="text-secondary hover:text-white duration-200">
                <a href="#skills" className="flex items-center gap-2">
                  <LiaShapesSolid className="text-primary" />
                  Skills
                </a>
              </li>
              <li className="text-secondary hover:text-white duration-200">
                <a href="#portfolio" className="flex items-center gap-2">
                  <RxDragHandleDots2 className="text-primary" />
                  Portfolio
                </a>
              </li>
              <li className="text-secondary hover:text-white duration-200">
            ...
            <ul className="flex items-center gap-5 mt-5 text-secondary">
              <li className="cursor-pointer hover:text-[#28e98c] duration-200">
                <a href="https://www.linkedin.com/in/mehedi5/">
                  <FaLinkedinIn />
                </a>
              </li>
              <li className="cursor-pointer hover:text-[#28e98c] duration-200">
                <a href="https://www.facebook.com/MehediHasanNiloi/">
                  <FaFacebookF />
                </a>
              </li>
              <li className="cursor-pointer hover:text-[#28e98c] duration-200">
                <a href="https://twitter.com/mehedirhasan">
                  <RiTwitterXFill />
                </a>
              </li>
            </ul>
