...
[Your Contact Information]`;
  ...
  return (
    <div className="border border-neutral-500 rounded-xl p-3 h-fit mt-3">
      ...
      <span className="flex gap-1 text-2xl mt-2 mb-5">
        Mehedi{" "}
        <sup className="border rounded-full w-5 h-5 text-xs flex items-center justify-center font-normal">
          M
        </sup>
      </span>
      ...
      <h1 className="px-3 text-lg text-center mt-5">
        Md. Mehedi Hasan <br /> Front-End Developer
      </h1>
      ...
      <p className="text-xs text-center text-slate-200">
        Hello folks, I am Md. Mehedi Hasan a professional front-end developer
